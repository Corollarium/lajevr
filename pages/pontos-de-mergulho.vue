            ...
            >
              ...
              <div>
                ...
                <p class="dive-coordinates">
                  ...
                  Latitude: {{ selectedSiteData.lat }} <br>
                  <font-awesome-icon icon="arrows-alt-h" /> Longitude: {{ selectedSiteData.long }}
                </p>
                <p>
...
export default {
    ...
    filteredGallery () {
      ...
      return this.gallery.filter((i) => {
        ...
        if (
          r &&
          i.description &&
          replaceSpecialChars(i.description).search(r) !== -1
        ) {
          return true;
        }
  ...
  mounted () {
    ...
    this.head.description = this.$gettext(
      'Sobre o projeto Laje de Santos Virtual'
    );

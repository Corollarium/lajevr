    ...
    <section>
      ...
      <p>
        ...
        <span v-show="gpuTierLoaded" style="font-weight: bold">
          ...
          <span v-else-if="gpuTier.tier === 1"><i18n>Baixo desempenho, devagar</i18n></span>
          <span v-else-if="gpuTier.tier === 2"><i18n>Médio desempenho</i18n></span>
          <span v-else-if="gpuTier.tier === 3"><i18n>Ótimo desempenho</i18n></span>
        </span>
      </p>
      <Underwater />
    </section>
